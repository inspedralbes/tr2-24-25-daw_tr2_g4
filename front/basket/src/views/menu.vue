...
<template>
  <main id="main_menu">
    ...
    <div id="div_menu" v-if="visibleOpciones">
      ...
      <br>
      <RouterLink to="/jugar/arcade" @click="ocultarTot">
        <q-btn color="deep-orange" class="botones_menu" glossy label="Arcade"></q-btn>
      </RouterLink>
      <br>
      <RouterLink to="/jugar/multijugador" @click="ocultarTot">
        <q-btn color="deep-orange" class="botones_menu" glossy label="Multijugador"></q-btn>
      </RouterLink>
      <br>
